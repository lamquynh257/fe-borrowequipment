...
export default function Computer() {
  ...
  const handleCreateNewRow = async (values) => {
    ...
    await axios
      .post(
        `${process.env.NEXT_PUBLIC_BACKEND_API}/api/createbranch`,
        {
          name: values.name,
  ...
  const handleSaveRowEdits = async ({ exitEditingMode, row, values }) => {
    ...
    axios
      .post(
        `${process.env.NEXT_PUBLIC_BACKEND_API}/api/editbranch`,
        {
          id: values.id,
          name: values.name,
          createdby: user.username,
  ...
  const handleDelete = async (row) => {
    ...
    await axios
      .post(
        `${process.env.NEXT_PUBLIC_BACKEND_API}/api/deletebranch`,
        {
          id: row.original.id,
        },
        {
